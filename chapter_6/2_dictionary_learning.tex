...
(A2) \textbf{Spectral Condition on Dictionary Elements}: The dictionary matrix has bounded spetral norm, for some constant $\mu_1>0$, $\lVert A^*\rVert<\mu_1\sqrt{r/d}$.
