...
Remarks and Observations:
  \begin{itemize}
      ...
      \item The embedding only depends on the subspace that $S$ resides in, and not $S$ itself. It is a \textit{universal embedding}, i.e. the embedding is oblivious to the actual configuration.
...
\end {itemize}    
If $S$ has the above property, then entire object can be embedded in $l_2$. The embedding and dimensionality would depend on the budget $\rho$.
\end{itemize}
