\section{Poincar\'e Embeddings for Learning Hierarchical Representations}
...
\begin{figure}
    \centering
    \includegraphics[width=.4\textwidth]{poincare1.png}
...
\subsection{Poincare Embeddings}
...
\section{Discussion of evaluation tasks and metrics}
...
\begin{figure}
    \centering
    \includegraphics[width=.7\textwidth]{poincare-embedding.png}
    \caption{Caption}
